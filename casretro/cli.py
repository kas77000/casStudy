...
One trading day, named or defaulted to the last business day.

This is the desk's own report: every section, every column, every row.  The
weekly review, and the version that goes to a trader or a client, is its own
command -- `python -m casretro_v2`.
